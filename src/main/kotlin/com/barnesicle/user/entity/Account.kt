...
data class Account constructor(@PrimaryKey val username: String,
                               ...
                               @Column("login_attempts") val loginAttempts: Int = 0){

    constructor(firstName: String, lastName: String, email: String, password: String,
                roles: Set<String>, created: Date, verified: Boolean = true, enabled: Boolean = true, loginAttempts: Int = 0) :
            this(email, firstName, lastName, email, password, roles, created, verified, enabled, loginAttempts)
}
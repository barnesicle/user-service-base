...
data class Account constructor(@PrimaryKey val username: String,
                               ...
                               @JsonIgnore @Column("password") val password: String,
                               ...
                               @JsonIgnore @Column("password_reset_code") val passwordResetCode: String,
                               @JsonIgnore @Column("verify_account_code") val verifyAccountCode: String){
